...
def BrutForce_MKP(Lv, Lw, W1, W2, s1, s2, opt1, opt2) :
    ...
    taken1 = indices(indices1)
    taken2 = indices(indices2)

    wasted_value1 = opt1 - in_sack_v1
    wasted_value2 = opt2 - in_sack_v2
...
knap = BrutForce_MKP(values, weights, capacities[0], capacities[1], s_sack1, s_sack2, optimal1, optimal2)
